...
public class AudioItemOverview : EditorWindow
{
    ...
    int colorIndex = 0;
    Color[] textColors = { Color.yellow, Color.green };
    ...
    void OnGUI()
    {
        ...
        styleEmptyButton.normal.textColor = headerStyle.normal.textColor;
        ...
        EditorGUILayout.BeginHorizontal();
        GUILayout.Button("Sub Item", styleEmptyButton);
            ...
            for (int categoryIndex = 0; categoryIndex < _selectedAC.AudioCategories.Length; categoryIndex++)
            {
                ...
                for (int itemIndex = 0; itemIndex < sortedAudioItems.Length; itemIndex++)
                {
                    ...
                    for (int subitemIndex = 0; subitemIndex < item.subItems.Length; subitemIndex++)
                    {
                        ...
                        styleButton.normal.textColor = textColors[colorIndex];

                        if (GUILayout.Button(subItemName, styleButton))
                        {
